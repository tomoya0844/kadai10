...
public class UserController {
    /**
     * UserServiceのインスタンスを格納するためのフィールド.
     * このサービスはユーザー関連の機能を提供します。
     */
     ...
     */
    @PostMapping("/users")
    public ResponseEntity<UserResponse> insert(final @RequestBody @Valid UserRequest userRequest, final UriComponentsBuilder uriBuilder) {
    ...
    public ResponseEntity<UserResponse> updateUser(final @PathVariable @Valid Integer id, final @RequestBody UserUpdateRequest updateRequest, final UriComponentsBuilder uriBuilder) {
